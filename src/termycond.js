  ...
  render() {
    ...
    return (
      <div className="TyC">
            ...
            <h2>¡Te damos la bienvenida a WERAISEN!</h2>
            <h3>1. Aceptación de los Términos de Uso.</h3>
            <h5>Al crear una cuenta de WeRaisen a través de un dispositivo móvil (colectivamente, el “Servicio”) estás de acuerdo en obligarte por estos términos de uso. Si no aceptas y acuerdas estar obligado por todos los términos de este, no deberás utilizar el Servicio.
            ...
            <h5>Debes tener al menos 18 años de edad para crear una cuenta en WeRaisen y utilizar el Servicio. Al crear una cuenta y utilizar el Servicio, declaras y garantizas que: 
            <ul class="list-unstyled">
              <li>• puedes formar un contrato vinculante con WeRaisen,</li>
...
ERES EL ÚNICO RESPONSABLE DE TUS INTERACCIONES CON OTROS USUARIOS.ENTIENDES QUE WERAISEN NO VERIFICA LOS ANTECEDENTES PENALES DE SUS USUARIOS NI INVESTIGA DE OTRO MODO LOS ANTECEDENTES DE SUS USUARIOS. WERAISEN NO DECLARA NI GARANTIZA LA CONDUCTA DE SUS USUARIOS. WERAISEN SE RESERVA EL DERECHO A REALIZAR —Y TÚ ACEPTAS QUE WERAISEN PUEDA REALIZAR— UNA VERIFICACIÓN DE LOS ANTECEDENTES PENALES Y OTROS CRIBADOS (COMO BÚSQUEDAS EN LOS REGISTROS DE CRIMINALES SEXUALES) EN CUALQUIER MOMENTO USANDO LOS REGISTROS PÚBLICOS DISPONIBLES
            ...
            <h3>6. Respeto</h3>
            <h5>La comunidad internacional de WeRaisen es tan diversa, singular y dinámica como el mundo en el que vivimos. Ser justos los unos con los otros es lo que nos une, lo que permite que nos integremos en un grupo a la perfección y que sintamos que podemos disfrutar de cualquier rincón del planeta.</h5>
            <h4>6.1 Mostrar actitudes intolerantes o discriminatorias</h4>
            <h5>Debes tratar a todo el mundo con el respeto que se merece. Por eso, es importante que no discrimines a otras personas en función de su color de piel, etnia, nacionalidad, religión, orientación sexual, género o identidad de género, discapacidad o enfermedad. Por descontado, no toleramos los insultos u ofensas a otras personas por estos motivos.</h5>
            <h4>6.2 Intimidar o acosar a otros miembros o usuarios</h4>
            <h5>No debes compartir los datos privados de otras personas para humillarlas o chantajearlas ni mostrar una actitud abusiva hacia ellas o difamarlas o infringir nuestras normas de evaluación y de contenidos.</h5>
            <h3>7. Autenticidad</h3>
            <h5>Tus experiencias en WeRaisen deberían estar llenas de buenos momentos y aventuras sorprendentes. La confianza es uno de los pilares de nuestra comunidad, por lo que la honestidad es un valor imprescindible. Es importante que haya un equilibrio entre las expectativas de los anfitriones y los huéspedes, que ambas partes demuestren su sinceridad y que los datos que proporcionen sean fiables.</h5>
            <h4>7.1 Facilitar datos falsos sobre ti</h4>
            <h5>No debes proporcionar un nombre o una fecha de nacimiento falsos, utilizar el alojamiento con fines comerciales o para celebrar eventos o fiestas sin la aprobación del anfitrión, tener cuentas duplicadas o registrarte si eres menor de 18 años.</h5>
            <h3>8. Fiabilidad</h3>
            <h5>Cada experiencia con WeRaisen es única. Cuando nuestra comunidad se compromete a brindar un abanico de posibilidades tan amplio, la veracidad y la fiabilidad son esenciales, tanto en la comunicación entre los usuarios como las valoraciones de los mismos.</h5>
            <h4>8.1 Romper compromisos</h4>
            <h5>Salvo por causas de fuerza mayor, no deberías cancelar tu encuentro después de haber acordado con la otra parte.</h5>
            <h4>8.2 No responder o no estar disponible</h4>
            <h5>No deberías recibir valoraciones negativas de forma continua y reiterada, ni desentenderte de tu encuentro una vez aceptada la solicitud.</h5>
            <h3>9. Derechos que WeRaisen te otorga.</h3>
            <h5>WeRaisen te concede una licencia personal, mundial, exenta de regalías, no asignable, no exclusiva, revocable y no transferible a terceros para acceder y utilizar el Servicio. Esta licencia se otorga con el único propósito de que te permita usar y disfrutar de los beneficios del Servicio de la forma prevista por WeRaisen y permitida por el presente Acuerdo. Por lo tanto, acuerdas:
<ul class="list-unstyled">
...
<li>•	no utilizar, acceder ni publicar la interfaz de programación de la aplicación de WeRaisen sin nuestro consentimiento por escrito.</li>
...
La Compañía puede investigar y tomar las acciones legales disponibles en respuesta al uso ilegal y/o no autorizado del Servicio, incluida la terminación de tu cuenta.
            ...
            <h5>Aunque WeRaisen se reserva el derecho de revisar y eliminar el Contenido que viole este Acuerdo, dicho Contenido es responsabilidad exclusiva del usuario que lo publica, y WeRaisen no puede garantizar que todo el Contenido cumpla con este Acuerdo. Si ves Contenido en el Servicio que viole este Acuerdo, por favor reportarlo.</h5>
            <h3>11. Servicios de terceros.</h3>
            <h5>El Servicio puede contener anuncios y promociones ofrecidos por terceros y enlaces a otros sitios web o recursos. WeRaisen no es responsable de la disponibilidad (o falta de disponibilidad) de dichos sitios web o recursos externos. Si decides interactuar con los terceros puestos a disposición a través de nuestro Servicio, los términos de dicha parte regirán su relación contigo. WeRaisen no es responsable de los términos o acciones de dichos terceros.</h5>
            <h3>12.	Lugar de encuentro.</h3>
            <h5>Queda fuera de nuestro alcance intervenir en la elección del lugar de encuentro entre el guía y el turista. El Servicio garantizará la seguridad hasta el momento del inicio del chat, luego queda a cargo de las partes.</h5>
