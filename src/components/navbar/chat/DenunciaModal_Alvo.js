          ...
          <Form>
            ...
            <Modal.Body>
              ...
              <div className="checkbox">
                <label>
                  <input style={{ paddingLeft: "5px" }} checked={this.state.sexual} onChange={() => this.setState({ sexual: true, violencia: false, discriminacion: false, suplantacion: false, otro: false })} name="reason" type="radio" required='true' /> Acoso sexual y/o verbal.
           </label>
              </div>

              <div className="checkbox">
                <label>
                  <input style={{ paddingLeft: "5px" }} checked={this.state.discriminacion} onChange={() => this.setState({ discriminacion: true, violencia: false, sexual: false, suplantacion: false, otro: false })} name="reason" type="radio" value="option" required />
                Discriminación.
            </label>
              </div>
              ...
              <div className="checkbox">
                <label>
                  <input checked={this.state.suplantacion} onChange={() => this.setState({ suplantacion: true, violencia: false, sexual: false, discriminacion: false, otro: false })} name="reason" type="radio" value="option" style={{ paddingLeft: "5px" }} required />
              ...
              <div className="checkbox">
                <label>
                  <input checked={this.state.violencia} onChange={() => this.setState({ violencia: true, sexual: false, discriminacion: false, suplantacion: false, otro: false })} name="reason" type="radio" value="option" style={{ paddingLeft: "5px" }} required />
              ...
              <div className="checkbox">
                <label >
                  <input checked={this.state.otro} onChange={() => this.setState({ otro: true, violencia: false, sexual: false, discriminacion: false, suplantacion: false })} name="reason" type="radio" value="option" style={{ paddingLeft: "5px" }} required />
                                      Otro motivo.
                                 </label>
              </div>
              <br></br>
