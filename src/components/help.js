...
class Help extends Component {
    ...
    return (
        <div className="contaainer">
          ...
          <div>
            <h2 style={{color:'#F9AA68'}}>¿Cómo creo una cuenta en WeRaisen?</h2>
            <br></br>
          </div>
        <div>
           <h4 align="left">Para crear tu cuenta de WeRaisen deberás presionar "Registrate ahora” en la pantalla de inicio de sesión. Allí te redireccionará a la página de creación de usuario, en la cual deberás ingresar los siguientes datos personales:
               <ul align="center"> 
          ...
          <br></br>
          <div>
            <h2>¿Cómo busco un guía e inicio un encuentro?</h2>
            <br></br>
          </div>
        <div>
           <h4 align="left"> Luego de iniciar sesión, deberas dirigirte a la opción "Buscar guía" del menú principal. 
        ...
        <div>
           <h4 align="left"> Una vez que iniciaste sesión, tendrás en tu perfil la opción para activarte como guía.
          ...
          <br></br>
          <div>
            <h2>¿Qué hago si detecto anomalías en el guía/turista seleccionado?</h2>
            <br></br>
          </div>
        <div>
           <h4 align="left"> Si encontrás que el guía o turista es irrespetuoso, perfil falso o envía contenidos de índole sexual, podrás 
          ...
          <br></br>
          <div>
            <h2>¿Cómo registro una valoración?</h2>
            <br></br>
          </div>
        <div>
        <a align="left"><h4 align="left"> Una vez finalizado el encuentro, recibirás una notificación para dejar una valoración al turista o guía. Esta pantalla consistirá en primer lugar, una puntuación del 1 al 5, siendo 1 la peor valoración y el 5 la mejor. Luego, podrás agregar una reseña opinando sobre el guía o turista.   
           </h4> </a>
          </div>
          <br></br>
          <br></br>
          <div>
            <h2>¿Cómo contacto al equipo de WeRaisen ?</h2>
            <br></br>
          </div>
        <div>
           <a align="left"><h4 style ={{ align:"left"}} > Podés contactar al equipo de WeRaisen al email: weraisen@gmail.com.   
           </h4> </a>
          </div>
         <br></br>
         <br></br>
         <input type="button" style ={{ paddingBottom:"10px"}} className="btn-primero" value="Volver" onClick={() => this.setState({ goToLogin: true })} />
         <br></br>
        </div>
